          ...
          <Row>
                <Col sm="12">
                    <div className="title-box text-center">
                        ...
                        <button  className="click-hed" style={{color:"white",cursor:"pointer"}}><a href="https://64991c1fb48fbc7d6c584aaa--tubular-fairy-c98b23.netlify.app/" target="_blank" style={{color:" #f56363",cursor:"pointer"}} >Click here</a></button>
                    </div>
                </Col>
            </Row>
