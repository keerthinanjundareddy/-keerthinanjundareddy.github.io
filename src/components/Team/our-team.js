          ...
          <Row>
                <Col sm="12">
                    <div className="title-box text-center">
                        ...
                        <button  className="click-hed" style={{color:"white",cursor:"pointer"}}><a href="https://incomparable-hamster-92fd22.netlify.app/" target="_blank" style={{color:" #f56363",cursor:"pointer"}} >Click here</a></button>
                    </div>
                </Col>
            </Row>
